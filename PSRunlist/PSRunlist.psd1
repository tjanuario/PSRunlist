...
#
# Module Manifest for Module 'PSRunlist.psd1
#
...
@{
    ...
    # Module Loader File
    RootModule = 'PSRunlist.psm1'
    
    # Version Number
    ModuleVersion = '1.7.0'
    
    # Unique Module ID
    GUID = 'ca91e5fd-0ed0-449f-b05b-a79ec09046cc'
    ...
    FunctionsToExport = 'New-Runlist', 'Format-Json', 'Invoke-Runlist'
